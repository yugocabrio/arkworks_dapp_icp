...
// （なんちゃって）Trusted Setupによって生成したVerificationKey
// VerificationKey generated by Trusted Setup
...
// 以下テスト関数です。serialize化されたProofとvkを使って、verificationをすることを確認します。
// The following is a test function to make sure it does verification with serialized proof and vk.
